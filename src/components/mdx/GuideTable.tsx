...
import guideTables from "@/data/guide-tables.json";
...
export function GuideTable({ id, lang }: GuideTableProps) {
    const locale = lang || 'en';
    const tableData = (guideTables as Record<string, TableDef>)[id];
