                    ...
                    <div className="lg:col-span-8">
                        ...
                        <header className="mb-12 border-b border-white/5 pb-12">
                            ...
                            <div className="flex flex-wrap items-center gap-6 mb-8 font-mono text-sm border-l-2 border-yellow-500 pl-4">
                                {tool.subcategory && (
                                    <span className="px-2 py-1 rounded border border-yellow-500/20 text-xs font-bold uppercase bg-yellow-500/10 text-yellow-500">
                                        {tool.subcategory}
                                    </span>
                                )}
                                <div className="flex items-center text-neutral-500">
                                    <span className="mr-2">UPDATED:</span>
                                    <span className="text-neutral-300">{tool.date}</span>
                                </div>
                            </div>
