...
export default function MapDetailClient({ map, lang, prevArticle, nextArticle }: MapDetailClientProps) {
    const locale = lang;
            ...
            <div className="mb-8 pl-0">
                <Breadcrumb
                    items={[
                        ...
                        { label: map.title.toUpperCase(), href: `/${locale}/maps/${map.slug}` }
                    ]}
                />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="prose prose-invert prose md:prose-lg prose-yellow max-w-none 
                            ...
                            <MDXRemote {...map.content} components={hydratedComponents} />
                        </div>
                        ...
                        <div className="mt-16 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-6">
                            {prevArticle ? (
                                <Link
                                    href={`/${locale}/maps/${prevArticle.slug}`}
                            ...
                            {nextArticle ? (
                                <Link
                                    href={`/${locale}/maps/${nextArticle.slug}`}
