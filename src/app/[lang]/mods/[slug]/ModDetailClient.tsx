...
export default function ModDetailClient({ mod, lang, prevArticle, nextArticle, children }: ModDetailClientProps) {
            ...
            <div className="mb-8 pl-0">
                <Breadcrumb
                    items={[
                        ...
                        { label: 'MODS', href: `/${lang}/mods` },
                        { label: mod.title.toUpperCase(), href: `/${lang}/mods/${mod.slug}` }
                    ]}
                />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="mt-16 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-6">
                            {prevArticle ? (
                                <Link
                                    href={`/${lang}/mods/${prevArticle.slug}`}
                            ...
                            {nextArticle ? (
                                <Link
                                    href={`/${lang}/mods/${nextArticle.slug}`}
